...
<script type="text/javascript" src="<%=path%>/common/js/easyui/js/jquery.easyui.min.js"></script>
<script type="text/javascript" src="<%=path%>/common/js/easyui/js/easyui-lang-zh_CN.js" ></script>
    ...
    $obj.datagrid({  
        ...
        idField:'jobId',
			...
			remoteSort : false,
                ...
                border: false,  
        columns : [ [
            {field : 'userId', title : '账户',hidden:true},
			{field : 'userName', title : "用户名称", width : 200, editor : 'text', sortable : true},
			{field : 'pwd', title : "密码", editor : 'text', width : 200, sortable : true},
			{field : 'realName', title : "真实姓名", editor : 'text', width : 200, sortable : true},
            {field : 'status', title : "用户性质", editor : 'text', width : 200, sortable : true},
			{field : 'sex', title : "性别", editor : 'text', width : 200, sortable : true},
			{field : 'phone', title : "电话", editor : 'text', width : 200, sortable : true},
			{field : 'email', title : "邮箱", editor : 'text', width : 200, sortable : true},
			{field : 'createTime', title : "创建时间", editor : 'text', width : 200, sortable : true},
			{field : 'opt', title : "详情", width : 150, align : 'center',
