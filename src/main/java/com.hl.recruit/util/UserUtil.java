...
public class UserUtil {
	...
	public static void saveUserInfoToSession(HttpSession session, UserEntity user) {
		session.setAttribute(USER, user);
	}
	...
	public static UserEntity getUserFromSession(HttpSession session) {
		...
		return attribute == null ? null : (UserEntity) attribute;
	}
	...
	public static UserEntity getUser() {
		...
		if(currentUser!=null) {
			return (UserEntity) currentUser.getSession().getAttribute("user");
		}else {
			return null;
		}
	}
